...
def test_choice_outer():
    ...
    class Test(TestSetup):
        choice: str
        something: haven.Component[Base, str] = haven.choice([a, b], key_field="choice", outer=True)
...
def test_choice_outer_default():
    ...
    class Test(TestSetup):
        name: str = "a"
        something: haven.Component[Base, str] = haven.choice(
            [a, b],
            key_field="name",
            outer=True,
            default_factory=lambda: haven.Component(ChildA(), a),
        )
